...
function CallToAction() {
  return <section className="px-4 py-20 sm:px-6 lg:px-8 lg:py-28"><div className="mx-auto max-w-5xl rounded-4xl bg-linear-to-br from-hunter-green-500 to-pine-teal-100 px-6 py-14 text-center text-white shadow-2xl sm:px-12"><MessagesSquare className="mx-auto size-9 text-dry-sage-500" aria-hidden="true" /><h2 className="mt-5 text-balance text-3xl font-black sm:text-5xl">Conecte sua equipe dentro da operação</h2><p className="mx-auto mt-5 max-w-2xl text-pretty leading-7 text-dry-sage-800">Descubra como o Chat Interno da NovoCode reduz ruídos e acelera decisões.</p><button type="button" data-plan="Chat Interno" className="h-widget-trigger mt-8 inline-flex min-h-12 items-center justify-center gap-2 rounded-full bg-dry-sage-500 px-7 py-3 text-sm font-black text-pine-teal-100 transition hover:-translate-y-0.5 hover:bg-white focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-white">Falar com especialista <MessageCircle className="size-4" aria-hidden="true" /></button></div></section>;
}
