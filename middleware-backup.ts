...
export async function middleware(request: NextRequest) {
  // Log simples para teste
  console.log("🛡️ MIDDLEWARE EXECUTANDO - ROTA:", request.nextUrl.pathname);
  ...
  if (isMaintenanceMode && !isMaintenanceAllowed) {
    ...
    console.log("🔍 Rota atual:", request.nextUrl.pathname, "Permitida:", isMaintenanceAllowed);
